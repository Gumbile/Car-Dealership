  ...
  <div class="container signInPage">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-lg-6 col-md-8">
        <div class="card signInCard">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col"></div>
              <div class="col-6">
                <form id="myForm" method="POST" action="../Result/result.php">
                  <div class="formHolder">
                    <div class="mb-3">
                      <input placeholder="Email address" type="email" class="form-control" name="email" id="InputEmail"
                        aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                      <div id="emptyEmail" class="form-text text-danger visually-hidden">Empty Field</div>
                    </div>
                    ...
                    <div class="mb-3">
                      <div id="emptyPassword" class="form-text text-danger visually-hidden">Empty Field</div>
                    </div>
                    <div class="mb-2 form-remember">
                      <a href="#" class="link-sec link-primary">Forgot password?</a>
                    </div>
                    <div class="d-grid gap-2 col-12 mx-auto">
                      <input class="btn btn-primary" id="submit" type="submit" value="Log In"></input>
                    </div>
        ...
        <div class="form-signup"><a href="http://localhost/Form/Registration%20Page/Email.php"
