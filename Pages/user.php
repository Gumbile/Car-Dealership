    ...
    <script>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <button class="btn btn-primary mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#searchCollapse"
                        ...
                        <div class="card card-body">
                            <form method="GET">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="range" class="form-range" id="baseRateMin" name="baseRateMin" min="0" max="100"
                                        step="0.01" value="0.0">
                                        <output for="baseRateMin" id="baseRateMinValue">0.00</output>
                                </div>
                                <div class="mb-3">
                                    <label for="baseRateMax" class="form-label">Base Rate (Max)</label>
                                    <input type="range" class="form-range" id="baseRateMax" name="baseRateMax" min="0" max="100"
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        if ($row["Status_"] == "Available") {
                                            echo "<td><a href='reserve.php?plateID=" . $row["PlateID"] .
                                                "&model=" . urlencode($row["Model"]) .
                                                "&year=" . $row["Year_"] .
                                                "&baseRate=" . $row["BaseRate"] .
                                                "&location=" . urlencode($row["LocationName"]) .
                                                "&status=" . $row["Status_"] .
                                                "' class='btn btn-primary'>Reserve</a></td>";
                                        } else {
                                            echo "<td></td>";
                                        }
